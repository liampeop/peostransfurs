...
public class Latex_Drone_Wolf_Model extends AdvancedHumanoidModel<Latex_Drone_Wolf> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Peostransfurs.MODID, "latex_drone_wolf"), "main");
    ...
    private final HumanoidAnimator<Latex_Drone_Wolf, Latex_Drone_Wolf_Model> animator;

    public Latex_Drone_Wolf_Model(ModelPart root) {
        super(root);
    ...
    @Override
    public HumanoidAnimator<Latex_Drone_Wolf, ?> getAnimator(Latex_Drone_Wolf whiteMouse) {
