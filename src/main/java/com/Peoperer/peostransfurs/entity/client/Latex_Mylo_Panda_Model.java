...
public class Latex_Mylo_Panda_Model extends AdvancedHumanoidModel<Latex_Mylo_Panda> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Peostransfurs.MODID, "latex_mylo_panda"), "main");
    ...
    private final HumanoidAnimator<Latex_Mylo_Panda, Latex_Mylo_Panda_Model> animator;


    public Latex_Mylo_Panda_Model(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition right_ear_r1 = RightEar.addOrReplaceChild("right ear_r1", CubeListBuilder.create().texOffs(0, 59).addBox(5.75F, -34.75F, -1.0F, 2.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5F, 30.0F, 0.0F, 0.0F, 0.0F, -0.3054F));

        PartDefinition LeftEar = Head.addOrReplaceChild("LeftEar", CubeListBuilder.create(), PartPose.offset(2.5F, -5.0F, 0.0F));

        PartDefinition left_ear_r1 = LeftEar.addOrReplaceChild("left ear_r1", CubeListBuilder.create().texOffs(16, 32).addBox(-7.75F, -34.75F, -1.0F, 2.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.5F, 30.0F, 0.0F, 0.0F, 0.0F, 0.3054F));
    ...
    @Override
    public HumanoidAnimator<Latex_Mylo_Panda, ?> getAnimator(Latex_Mylo_Panda whiteMouse) {
