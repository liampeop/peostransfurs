...
public class Red_Latex_Drone_Wolf_Model extends AdvancedHumanoidModel<Red_Latex_Drone_Wolf> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Peostransfurs.MODID, "red_latex_drone_wolf"), "main");
    ...
    private final HumanoidAnimator<Red_Latex_Drone_Wolf, Red_Latex_Drone_Wolf_Model> animator;

    public Red_Latex_Drone_Wolf_Model(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 16).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F))
                .texOffs(0, 66).addBox(-3.5F, -6.25F, -4.2F, 7.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(15, 32).addBox(-2.0F, -3.0F, -6.0F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(24, 22).addBox(-1.5F, -1.0F, -5.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(82, 0).addBox(-3.5F, -8.0F, -4.05F, 7.0F, 4.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(82, 2).addBox(-3.5F, -6.2F, -4.3F, 7.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -0.5F, 0.0F));
        ...
        PartDefinition Torso = partdefinition.addOrReplaceChild("Torso", CubeListBuilder.create().texOffs(28, 28).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(82, 55).addBox(-2.5F, 7.75F, -2.1F, 5.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -0.5F, 0.0F));
        ...
        PartDefinition RightArm = Torso.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(16, 40).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-5.0F, 2.0F, 0.0F));
    ...
    @Override
    public HumanoidAnimator<Red_Latex_Drone_Wolf, ?> getAnimator(Red_Latex_Drone_Wolf whiteMouse) {
